...
class UpdateUserRequest extends FormRequest
{
    ...
    {
        return [
            "username" => "max:30|regex:/^[A-Za-z0-9\-_]+$/|unique:users,username,except,id",
    ...
    public function messages()
    {
        return [
            ...
            "address.required" => "manzil kiriting",
            "address.min" => "manzil 3 ta belgidan kam bo'lmasligi kerak",
            "address.max" => "manzil 30 ta belgidan kam bo'lishi kerak",
        ];
    }
}
